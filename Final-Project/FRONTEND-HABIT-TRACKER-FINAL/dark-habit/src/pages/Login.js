  ...
  return (
    <div className="celebration-overlay">
      ...
      <div className="celebration-card">
        ...
        <div className="celeb-title">Welcome back!</div>
        <div className="celeb-name">{name}</div>
        <div className="celeb-sub">Your streak is waiting 🔥</div>
...
export default function Login() {
  ...
  const submit = async e => {
    ...
    try {
      ...
      setCelebrate(res.data?.name || 'Friend');
    } catch (err) {
  ...
  return (
    <div className="auth-bg">
      ...
      <div className="bg-orb orb9" />
      <div className="bg-orb orb10" />
      <div className="bg-orb orb11" />
      <div className="bg-orb orb12" />
      ...
      <div className="mascots-left">
        ...
        <Mascot size={90}  emoji1="🌟" emoji2="💫" delay={1.2} />
        <Mascot size={130} emoji1="😄" emoji2="🎯" delay={0.6} />
        <Mascot size={110} emoji1="🎈" emoji2="🔑" delay={1.5} />
      </div>
      ...
      <div className="mascots-right">
        ...
        <Mascot size={90}  emoji1="🎉" emoji2="🚀" delay={1.4} />
        <Mascot size={130} emoji1="🏅" emoji2="💥" delay={0.9} />
      </div>

      {/* CENTER column: tagline above card */}
      <div className="auth-layout">

        <div className="auth-tagline">
          Build habits.<br />Track progress. Win.
        </div>
